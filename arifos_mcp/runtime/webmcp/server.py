...
class WebMCPGateway:
    ...
    Usage:
        from arifos_mcp.runtime.webmcp import WebMCPGateway
    ...
    def _setup_routes(self):
        ...
        async def verify_agent_did(did: str):
            ...
            return {
                ...
                "governance_endpoints": ["https://arifos_mcp.arif-fazil.com/governance/evaluate"],
                "verdict": "SEAL",
            }
        ...
        async def resolve_hold(hold_id: str, request: Request):
            ...
            try:
                ...
                from arifos_mcp.runtime.cross_protocol_bridge import get_hold_bridge
    ...
    async def _on_hold_event(self, event):
        ...
        message = {
            ...
            "payload": {
                ...
                "review_url": f"https://arifos_mcp.arif-fazil.com/hold/{event.hold_id}",
            }
        }
...
def create_webmcp_app(mcp_server: Any) -> FastAPI:
    ...
    Usage:
        from arifos_mcp.runtime.webmcp import create_webmcp_app
